...
c.set.on('change', function(v){
  if(v){ sintes[i]
    s.fdelay.delayTime.linearRampTo(Nexus.rf(0.01,1), Nexus.rf(0.01,1));
    s.fdelay.feedback.linearRampTo(Nexus.rf(0.01,1), Nexus.rf(0.01,1));
    s.loop.interval = Nexus.rf(0.01,1);
  }
  else{
    s.fdelay.delayTime.linearRampTo(Nexus.rf(0.01,1),Nexus.rf(0.01,1));
    s.fdelay.feedback.linearRampTo(Nexus.rf(0.01,1),Nexus.rf(0.01,1));
...
c.wetdelay.on('change',function(v) {
  // console.log(v);
  s.delaywet(v);
});

// c.slider1.on('change',function(v) {
//   // console.log(v);
//   s.delaytime(v);
// });
...
console.log(s.synth.get());
console.log(s.fdelay.get());
